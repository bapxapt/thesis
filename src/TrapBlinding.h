...
#ifndef NOTAGAME_TRAP_TELEPORTING_H
#define NOTAGAME_TRAP_TELEPORTING_H
...
class TrapBlinding: public TrapGeneric {
public:
    TrapBlinding(const std::string&, size_t, size_t, enumMaterial, size_t, 
				 float, const UnitMap&);
...
inline const UnitMap& TrapBlinding::GetUnitMap() const {
	return m_oUnitMap;
}
